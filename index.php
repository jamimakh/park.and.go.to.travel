...
<html lang="en">
    <head>
        ...
        <title>Park and go to Travel || Home Page</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="index.php">Park and go to Travel</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Park and go to Travel</h1>
                <!-- Icon Divider-->
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Park and go to Travel @ 2023</small></div>
        </div>
        <!-- Bootstrap core JS-->
